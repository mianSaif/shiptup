                ...
                <div class="qodef-header-wrapper">
                    ...
                    <nav class="qodef-header-navigation" role="navigation" aria-label="Top Menu">
                        <ul id="menu-main-menu-1" class="menu">
                            <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-31 qodef-menu-item--narrow"><a href="{{ url('/') }}"><span class="qodef-menu-item-text">Homes<svg class="qodef-svg--menu-arrow qodef-menu-item-arrow" xmlns="http://www.w3.org/2000/svg" width="8.485" height="14.14" viewBox="0 0 8.485 14.14">
                            ...
                            <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-31 qodef-menu-item--narrow"><a href="{{ url('about') }}"><span class="qodef-menu-item-text">Who We Are<svg class="qodef-svg--menu-arrow qodef-menu-item-arrow" xmlns="http://www.w3.org/2000/svg" width="8.485" height="14.14" viewBox="0 0 8.485 14.14">
                                            <g transform="translate(-1371.757 -219.93)">
                                                <rect width="10" height="2" transform="translate(1380.243 226.999) rotate(135)" />
                                                <rect width="10" height="2" transform="translate(1378.829 228.415) rotate(-135)" />
                                            </g>
        ...
        <header id="qodef-page-mobile-header" role="banner">
            ...
            <nav class="qodef-mobile-header-navigation" role="navigation" aria-label="Mobile Menu">
                <ul id="menu-main-menu-4" class="">
                    <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-31 qodef-menu-item--narrow"><a href="{{ url('/') }}"><span class="qodef-menu-item-text">Homes</span></a><svg class="qodef-svg--menu-arrow qodef-menu-item-arrow" xmlns="http://www.w3.org/2000/svg" width="8.485" height="14.14" viewBox="0 0 8.485 14.14">
                            <g transform="translate(-1371.757 -219.93)">
                                <rect width="10" height="2" transform="translate(1380.243 226.999) rotate(135)" />
                                <rect width="10" height="2" transform="translate(1378.829 228.415) rotate(-135)" />
                            </g>
                        </svg></li>
                    <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-31 qodef-menu-item--narrow"><a href="{{ url('about') }}"><span class="qodef-menu-item-text">Who We Are</span></a><svg class="qodef-svg--menu-arrow qodef-menu-item-arrow" xmlns="http://www.w3.org/2000/svg" width="8.485" height="14.14" viewBox="0 0 8.485 14.14">
                            <g transform="translate(-1371.757 -219.93)">
                                <rect width="10" height="2" transform="translate(1380.243 226.999) rotate(135)" />
                                <rect width="10" height="2" transform="translate(1378.829 228.415) rotate(-135)" />
                            </g>
            ...
            <div class="qodef-page-title qodef-m qodef-title--standard-with-breadcrumbs qodef-alignment--left qodef-vertical-alignment--window-top">
                <div class="qodef-m-inner">
                    <div class="qodef-m-content qodef-content-grid ">
                        <div itemprop="breadcrumb" class="qodef-breadcrumbs"><a itemprop="url" class="qodef-breadcrumbs-link" href="{{ url('/') }}"><span itemprop="title">Home</span></a><span class="qodef-breadcrumbs-separator"></span><span itemprop="title" class="qodef-breadcrumbs-current">Who We Are</span></div>
                                                ...
                                                <div class="elementor-widget-wrap elementor-element-populated">
                                                    <div class="elementor-element elementor-element-c50b959 elementor-widget elementor-widget-image" data-id="c50b959" data-element_type="widget" data-widget_type="image.default">
                                                        <div class="elementor-widget-container">
                                                            ...
                                                            </style> <img width="1920" height="600" src="{{ asset('wp-content/uploads/2021/12/who-we-are-img.jpg') }}" class="attachment-full size-full" alt="j" loading="lazy" srcset="wp-content/uploads/2021/12/who-we-are-img.jpg 1920w, {{ asset('wp-content/uploads/2021/12/who-we-are-img-800x250.jpg') }} 800w, {{ asset('wp-content/uploads/2021/12/who-we-are-img-300x94.jpg') }} 300w, {{ asset('wp-content/uploads/2021/12/who-we-are-img-1024x320.jpg') }} 1024w, {{ asset('wp-content/uploads/2021/12/who-we-are-img-768x240.jpg') }} 768w, {{ asset('wp-content/uploads/2021/12/who-we-are-img-1536x480.jpg') }} 1536w" sizes="(max-width: 1920px) 100vw, 1920px" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                        ...
                                                        <div class="elementor-widget-container">
                                                            <div class="qodef-shortcode qodef-m  qodef-single-image qodef-layout--default    ">
                                                                <div class="qodef-m-image">
                                                                    <img width="538" height="504" src="{{ asset('wp-content/uploads/2021/11/home-2-img-1.png') }}" class="attachment-full size-full" alt="r" loading="lazy" srcset="{{ asset('wp-content/uploads/2021/11/home-2-img-1.png') }} 538w, {{ asset('wp-content/uploads/2021/11/home-2-img-1-300x281.png') }} 300w" sizes="(max-width: 538px) 100vw, 538px" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="elementor-element elementor-element-2acd2d2 elementor-widget elementor-widget-shiftup_core_section_title" data-id="2acd2d2" data-element_type="widget" data-widget_type="shiftup_core_section_title.default">
                                                        <div class="elementor-widget-container">
                                                            <div class="qodef-shortcode qodef-m  qodef-section-title qodef-alignment--left ">
                                                                ...
                                                                <p class="qodef-m-text">We are the world's first company to provide services for electric cars. We feel proud of that and ensure you that you will get the best out of us!</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                                    ...
                                                                    <div class="qodef-m-content-inner">
                                                                        ...
                                                                        <div class="qodef-m-text-wrap">
                                                                            <p class="qodef-m-text">
                                                                                We repair fuel systems in all kinds of vehicles and improve the performance of fuel.</p>
                                                                            <p class="qodef-m-text">We repair fuel systems in all kinds of vehicles and improve the performance of fuel.</p>
                                                                        </div>
                                                                    </div>
                                                ...
                                                <div class="elementor-widget-wrap elementor-element-populated">
                                                    <div class="elementor-element elementor-element-3313920 elementor-widget elementor-widget-shiftup_core_banner" data-id="3313920" data-element_type="widget" data-widget_type="shiftup_core_banner.default">
                                                        <div class="elementor-widget-container">
                                                            <div class="qodef-shortcode qodef-m  qodef-banner qodef-layout--text-on-hover  ">
                                                                <div class="qodef-m-image">
                                                                    <img width="800" height="1160" src="{{ asset("wp-content/uploads/2021/11/h3-ban-img2.jpg") }}" class="attachment-full size-full" alt="j" loading="lazy" srcset="{{ asset('wp-content/uploads/2021/11/h3-ban-img2.jpg') }} 800w, {{ asset('wp-content/uploads/2021/11/h3-ban-img2-207x300.jpg') }} 207w, {{ asset('wp-content/uploads/2021/11/h3-ban-img2-706x1024.jpg') }} 706w, {{ asset('wp-content/uploads/2021/11/h3-ban-img2-768x1114.jpg') }} 768w" sizes="(max-width: 800px) 100vw, 800px" />
                                                                </div>
                                                                <div class="qodef-m-content">
                                                                    <div class="qodef-m-content-blur"></div>
                                                                    <div class="qodef-m-content-inner">
                                                                        ...
                                                                        <div class="qodef-m-text-wrap">
                                                                            <p class="qodef-m-text">
                                                                                Get your car checked and fixed. We provide complete diagnostics with out high power and accurate electrical components</p>
                                                                            <p class="qodef-m-text">
                                                                                Get your car checked and fixed. We provide complete diagnostics with out high power and accurate electrical components</p>
                                                                        </div>
                                                                    </div>
                                                ...
                                                <div class="elementor-widget-wrap elementor-element-populated">
                                                    <div class="elementor-element elementor-element-61746b3 elementor-widget elementor-widget-shiftup_core_banner" data-id="61746b3" data-element_type="widget" data-widget_type="shiftup_core_banner.default">
                                                        <div class="elementor-widget-container">
                                                            <div class="qodef-shortcode qodef-m  qodef-banner qodef-layout--text-on-hover  ">
                                                                <div class="qodef-m-image">
                                                                    <img width="800" height="1160" src="{{ asset("wp-content/uploads/2021/11/h3-ban-img3.jpg") }}" class="attachment-full size-full" alt="j" loading="lazy" srcset="{{ asset("wp-content/uploads/2021/11/h3-ban-img3.jpg 800w, wp-content/uploads/2021/11/h3-ban-img3-207x300.jpg 207w, wp-content/uploads/2021/11/h3-ban-img3-706x1024.jpg 706w, wp-content/uploads/2021/11/h3-ban-img3-768x1114.jpg 768w") }}" sizes="(max-width: 800px) 100vw, 800px" />
                                                                </div>
                                                                <div class="qodef-m-content">
                                                                    <div class="qodef-m-content-blur"></div>
                                                                    <div class="qodef-m-content-inner">
                                                                        ...
                                                                        <div class="qodef-m-text-wrap">
                                                                            <p class="qodef-m-text">
                                                                            We are experts in exhaust systems. We optimize the exhaust systems to ensure maximum heat dissipation and muting.        
                                                                        </p>
                                                                            <p class="qodef-m-text">
                                                                            We are experts in exhaust systems. We optimize the exhaust systems to ensure maximum heat dissipation and muting.</p>
                                                                        </div>
                                                                    </div>
                                                                    <div class="qodef-m-button">
                                                ...
                                                <div class="elementor-widget-wrap elementor-element-populated">
                                                    <div class="elementor-element elementor-element-04cb40b elementor-widget elementor-widget-shiftup_core_banner" data-id="04cb40b" data-element_type="widget" data-widget_type="shiftup_core_banner.default">
                                                        <div class="elementor-widget-container">
                                                            <div class="qodef-shortcode qodef-m  qodef-banner qodef-layout--text-on-hover  ">
                                                                <div class="qodef-m-image">
                                                                    <img width="800" height="1160" src="{{ asset("wp-content/uploads/2021/11/h3-ban-img4.jpg") }}" class="attachment-full size-full" alt="j" loading="lazy" srcset="{{ asset("wp-content/uploads/2021/11/h3-ban-img4.jpg 800w, wp-content/uploads/2021/11/h3-ban-img4-207x300.jpg 207w, wp-content/uploads/2021/11/h3-ban-img4-706x1024.jpg 706w, wp-content/uploads/2021/11/h3-ban-img4-768x1114.jpg 768w") }}" sizes="(max-width: 800px) 100vw, 800px" />
                                                                </div>
                                                                <div class="qodef-m-content">
                                                                    <div class="qodef-m-content-blur"></div>
                                                                    <div class="qodef-m-content-inner">
                                                                        ...
                                                                        <div class="qodef-m-text-wrap">
                                                                            <p class="qodef-m-text">Brakes are one of our major expertise. We repair and replace your brakes with our industry standard equipments</p>
                                                                            <p class="qodef-m-text">
                                                                            Brakes are one of our major expertise. We repair and replace your brakes with our industry standard equipments</p>
                                                                        </div>
                                                                    </div>
                                                                    <div class="qodef-m-button">
        ...
        <div id="qodef-content-bottom">
            <div id="qodef-content-bottom-inner" class="qodef-content-grid">
                <div id="block-11" class="widget widget_block" data-area="content-bottom">
                    ...
                    <p></p>
                    <p>Your Email ID is protected with us.</p>
                </div>
                        ...
                        <div class="qodef-grid-inner clear">
                            <div class="qodef-grid-item qodef-col--4 qodef--1024-col-4 qodef--768-col-6 qodef--680-col-12">
                                ...
                                <div id="block-20" class="widget widget_block" data-area="qodef-footer-top-area-column-1">
                                    <p>Hit the road with the astounding ShiftUp services, made especially for repair and services for your car.
                                    </p>
                                </div>
                                ...
                                <div id="block-16" class="widget widget_block" data-area="qodef-footer-top-area-column-1">
                                    <p style="margin:0px;">Our address</p>
