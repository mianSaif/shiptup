! function(a) {
    ...
    }), a(document).on("shiftup_trigger_get_new_posts", function() {
        _.init(), o.init()
    });
    var i = {
            init: function() {
            ...
            getEvents: function(o, n) {
                return {
                    on: {
                        ...
                        init: function() {
                            var t;
                            o.addClass("qodef-swiper--initialized"), qodef.body.trigger("shiftup_trigger_swiper_is_initialized", [o, n]), n.sliderScroll && (t = !1, o.on("mousewheel", function(e) {
...
function(o) {
    ...
    o(document).ready(function() {
        ...
        n.init()
    }), o(document).on("shiftup_trigger_get_new_posts", function(e, t) {
    ...
    var s = {
        ...
        setVisibility: function(e, t) {
            ...
            a.additional_query_args = {
                tax_query: t
            }, qodef.body.trigger("shiftup_trigger_load_more", [e, 1])
        },
...
function(r) {
    ...
    r(document).ready(function() {
        t.init()
    }), r(document).on("shiftup_trigger_get_new_posts", function() {
        t.init()
    });
    var t = {
        init: function() {
...
function(t) {
    ...
    t(document).ready(function() {
        ...
        n.reInit()
    }), t(document).on("shiftup_trigger_get_new_posts", function(e, t) {
...
function(a) {
    ...
    a(document).ready(function() {
        ...
        s.scroll()
    }), a(document).on("shiftup_trigger_load_more", function(e, t, i) {
            ...
            s.setNextPageValue(n, i, !1), a.ajax({
                ...
                success: function(e) {
                    "success" === e.status ? (n.max_pages_num !== e.data.max_pages_num && (n.max_pages_num = e.data.max_pages_num), s.setNextPageValue(n, i, !0), s.changeStandardHtml(t, n.max_pages_num, i, e.data.pagination_html), s.addPosts(o, e.data.html, i), s.reInitMasonryPosts(t, o), setTimeout(function() {
                        qodef.body.trigger("shiftup_trigger_get_new_posts", [t, e.data, i])
