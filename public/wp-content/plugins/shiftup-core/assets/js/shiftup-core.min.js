! function(t) {
    ...
    var e = {
            init: function() {
                var e;
                this.holder = t("#shiftup-core-page-inline-style"), !this.holder.length || (e = this.holder.data("style")).length && t("head").append('<style type="text/css">' + e + "</style>")
            }
        },
        i = {
            init: function() {
...
function(a) {
    ...
    var d = {
        init: function() {
            ...
            }), d.showHideBackToTop(), d.changeSkin())
        },
        animateScrollToTop: function() {
            function o() {
                var e;
                0 !== i && (i < 1e-4 && (i = 0), e = d.easingFunction((n - i) / n), a("html, body").scrollTop(n - (n - i) * e), i *= .9, t = requestAnimationFrame(o))
            }
            var t, n = qodef.scroll,
                i = qodef.scroll;
            o(), a(window).one("wheel touchstart", function() {
        ...
        changeSkin: function() {
            var t = a("#qodef-back-to-top"),
                e = a(".qodef-btt-light, .qodef-page-light-skin #qodef-page-outer, .qodef-page-default-skin #qodef-page-outer"),
                o = a(".qodef-btt-dark"),
                n = !1,
                i = !1,
                d = new Array,
                r = new Array;
            t.length && e.length && a(window).scroll(function() {
                e.length && (e.each(function(e) {
                    var o = a(this);
                    qodef.scroll + t.position().top >= o.offset().top && qodef.scroll + t.position().top <= o.offset().top + o.outerHeight() ? d[e] = !0 : d[e] = !1
                }), -1 != jQuery.inArray(!0, d) ? n || (t.addClass("qodef-light"), n = !0) : n && (t.removeClass("qodef-light"), n = !1))
            }), t.length && o.length && a(window).scroll(function() {
                o.length && (o.each(function(e) {
                    var o = a(this);
                    qodef.scroll + t.position().top >= o.offset().top && qodef.scroll + t.position().top <= o.offset().top + o.outerHeight() ? r[e] = !0 : r[e] = !1
                }), -1 != jQuery.inArray(!0, r) ? i || (t.addClass("qodef-dark"), i = !0) : i && (t.removeClass("qodef-dark"), i = !1))
            })
        }
    }
}(jQuery),
...
function(o) {
    ...
    var e = {
        init() {
            const t = o("#qodef-theme-cursor");
            t.find(".qodef-cursor-square");
            var e;
            t.length && 1024 < qodef.windowWidth && (t.css({
                transform: "matrix(1, 0, 0, 1, " + qodef.windowWidth / 2 + ", " + qodef.windowHeight / 2 + ")"
            }), o(document).on("mousemove", function(e) {
                var o = e.clientX,
                    e = e.clientY;
                t.css({
                    transform: "matrix(1, 0, 0, 1, " + o + ", " + e + ")"
                })
            }), e = ".qodef-interactive-link-showcase .qodef-m-item, .qodef-blog .qodef-blog-item .qodef-e-title .qodef-e-title-link, .qodef-portfolio-list .qodef-e-title-link, .qodef-woo-product-title-link, .qodef-image-with-text .qodef-m-title a, .qodef-blog .qodef-blog-item.format-link .qodef-e-link-url, .qodef-blog .qodef-blog-item.format-quote .qodef-e-quote-url, .qodef-image-with-text.qodef-action--scrolling-image .qodef-m-image-holder .qodef-m-image-holder-inner a, .qodef-hover-links a, #qodef-author-info .qodef-m-author a, .qodef-author-info-name a, .qodef-header-logo a, .qodef-header-logo-link, .rbt-toolbar a", o(document).on("mouseover", e, () => {
                t.removeClass("qodef-cursor--link"), t.addClass("qodef-cursor--link-svg")
            }), o(document).on("mouseleave", e, () => {
                t.removeClass("qodef-cursor--link-svg")
            }), e = ".qodef-side-area-cover, .mfp-wrap.mfp-ready, .qodef-fullscreen-search-holder .qodef-m-close", o(document).on("mouseover", e, () => {
                t.removeClass("qodef-cursor--link"), t.addClass("qodef-cursor--close-svg")
            }), o(document).on("mouseleave", e, () => {
                t.removeClass("qodef-cursor--close-svg")
            }), o(document).on("click", e => {
                (o(e.target).hasClass("qodef-side-area-cover") || o(e.target).hasClass("mfp-container")) && t.removeClass("qodef-cursor--close-svg")
            }))
        }
    }
}(jQuery),
...
function(e) {
    ...
    e(document).ready(function() {
        o.init(),
            function() {
                e("#qodef-page-wrapper");
                var o = e(".qodef-header-navigation>ul>li, .second, .widget_shiftup_core_woo_dropdown_cart"),
                    t = "qodef-dropdown-menu-opened";
                e(o).on("touchstart mouseenter", function(e) {
                    o.hasClass("opened") || (o.addClass("opened"), qodef.body.addClass(t))
                }).on("mouseleave", function(e) {
                    qodef.body.removeClass(t), o.removeClass("opened")
                })
            }()
    });
    var o = {
...
function(i) {
    ...
    var d = {
        ...
        fadeOutLoader: function(o, e, t) {
            var n = d.holder.length ? d.holder : i("#qodef-page-spinner:not(.qodef--custom-spinner)");
...
function(o) {
    "use strict";
    qodefCore.shortcodes.shiftup_core_accordion = {}, o(document).ready(function() {
        t.init()
    });
    var t = {
        init: function() {
    ...
    qodefCore.shortcodes.shiftup_core_accordion.qodefAccordion = t
}(jQuery),
function(e) {
    "use strict";
    qodefCore.shortcodes.shiftup_core_banner = {}, e(document).ready(function() {
        o.init()
    });
    var o = {
        init: function() {
            this.holder = e(".qodef-banner.qodef--has-appear"), this.holder.length && this.holder.each(function() {
                o.initItem(e(this))
            })
        },
        initItem: function(e) {
    ...
    qodefCore.shortcodes.shiftup_core_banner.qodefBanner = o
}(jQuery),
function(e) {
    "use strict";
    qodefCore.shortcodes.shiftup_core_button = {}, e(document).ready(function() {
        n.init()
    });
    var n = {
        init: function() {
    ...
    qodefCore.shortcodes.shiftup_core_button.qodefButton = n
}(jQuery),
function(n) {
    "use strict";
    qodefCore.shortcodes.shiftup_core_cards_gallery = {}, n(document).ready(function() {
        o.init()
    });
    var o = {
        init: function() {
    ...
    qodefCore.shortcodes.shiftup_core_cards_gallery.qodefCardsGallery = o
}(jQuery),
function(e) {
    "use strict";
    qodefCore.shortcodes.shiftup_core_countdown = {}, e(document).ready(function() {
        s.init()
    });
    var s = {
        init: function() {
    ...
    qodefCore.shortcodes.shiftup_core_countdown.qodefCountdown = s
}(jQuery),
function(r) {
    "use strict";
    qodefCore.shortcodes.shiftup_core_counter = {}, r(document).ready(function() {
        n.init()
    });
    var n = {
        init: function() {
    ...
    qodefCore.shortcodes.shiftup_core_counter.qodefCounter = n
}(jQuery),
function(o) {
    "use strict";
    qodefCore.shortcodes.shiftup_core_custom_font = {}, o(document).ready(function() {
        t.init()
    });
    var t = {
        init: function() {
            this.holder = o(".qodef-custom-font"), this.holder.length && this.holder.each(function() {
                var e = o(this);
                e.hasClass("qodef--has-appear") && t.backgroundText(e)
            })
        },
        backgroundText: function(e) {
            var o = e.find(".qodef-m-background-text");
            if (o.length) {
                var t = o.text(),
                    n = t.split("");
                o.empty();
                for (var i = 2; i < n.length; i++) n[i] = '<span class="qodef-m-background-character">' + n[i] + "</span>", t = n.join("");
                o.append(t);
                var d = e.find(".qodef-m-background-character");
                qodefCore.qodefIsInViewport.check(d, function() {
                    setTimeout(function() {
                        d.addClass("qodef--appear")
                    }, 100)
                })
            }
        }
    };
    qodefCore.shortcodes.shiftup_core_custom_font.qodefCustomFont = t
}(jQuery),
function(e) {
    "use strict";
    qodefCore.shortcodes.shiftup_core_google_map = {}, e(document).ready(function() {
        o.init()
    });
    var o = {
        init: function() {
    ...
    qodefCore.shortcodes.shiftup_core_google_map.qodefGoogleMap = o
}(jQuery),
function(e) {
    "use strict";
    qodefCore.shortcodes.shiftup_core_icon = {}, e(document).ready(function() {
        i.init()
    });
    var i = {
        init: function() {
    ...
    qodefCore.shortcodes.shiftup_core_icon.qodefIcon = i
}(jQuery),
function() {
    "use strict";
    qodefCore.shortcodes.shiftup_core_image_gallery = {}, qodefCore.shortcodes.shiftup_core_image_gallery.qodefSwiper = qodef.qodefSwiper, qodefCore.shortcodes.shiftup_core_image_gallery.qodefMasonryLayout = qodef.qodefMasonryLayout, qodefCore.shortcodes.shiftup_core_image_gallery.qodefMagnificPopup = qodef.qodefMagnificPopup
}(jQuery),
function(e) {
    "use strict";
    qodefCore.shortcodes.shiftup_core_image_section_info = {}, qodefCore.shortcodes.shiftup_core_image_section_info.qodefMagnificPopup = qodef.qodefMagnificPopup, qodefCore.shortcodes.shiftup_core_image_section_info.qodefAppear = qodef.qodefAppear, e(document).ready(function() {
        o.init()
    });
    var o = {
        init: function() {
            this.holder = e(".qodef-image-section-info.qodef--has-appear"), this.holder.length && this.holder.each(function() {
                o.initItem(e(this))
            })
        },
        initItem: function(e) {
    ...
    qodefCore.shortcodes.shiftup_core_image_section_info.qodefImageSectionInfo = o
}(jQuery),
function(c) {
    "use strict";
    qodefCore.shortcodes.shiftup_core_image_with_text = {}, qodefCore.shortcodes.shiftup_core_image_with_text.qodefMagnificPopup = qodef.qodefMagnificPopup, c(document).ready(function() {
        e.init()
    });
    var e = {
        init: function() {
            ...
            e.length && e.each(function() {
                function e() {
                    o = a.height(), t = s.height(), a.width(), s.width(), n = Math.round(t - o), i = 2 * Math.round(t / o), o < t && (f = !0)
                }
                var o, t, n, i, d = c(this),
                    r = d.find(".qodef-m-image"),
                    a = d.find(".qodef-e-frame"),
                    s = d.find(".qodef-e-main-image"),
                    f = !1;
                d.css("visibility", "visible"), e(), r.mouseenter(function() {
                    s.css("transition-duration", i + "s"), s.css("transform", "translate3d(0px, -" + n + "px, 0px)")
                }), r.mouseleave(function() {
                    f && (s.css("transition-duration", Math.min(i / 3, 3) + "s"), s.css("transform", "translate3d(0px, 0px, 0px)"))
    ...
    qodefCore.shortcodes.shiftup_core_image_with_text.qodefScrollingImage = e
}(jQuery),
function() {
    "use strict";
    qodefCore.shortcodes.shiftup_core_interactive_link_showcase = {}
}(jQuery),
function(e) {
    "use strict";
    qodefCore.shortcodes.shiftup_core_item_showcase = {}, e(document).ready(function() {
        o.init()
    });
    var o = {
        init: function() {
            this.holder = e(".qodef-item-showcase"), this.holder.length && this.holder.each(function() {
                o.initItem(e(this))
            })
        },
        initItem: function(e) {
    ...
    qodefCore.shortcodes.shiftup_core_item_showcase.qodefItemShowcaseList = o
}(jQuery),
function(d) {
    "use strict";
    d(document).ready(function() {
    ...
    var e = {
        backgroundAnimation: function() {
            var e = d(".qodef--pricing-has-appear > div ");
            e.length && e.each(function() {
                var n = d(this);
                n.append('<div class="qodef-pricing-table-background"></div>');
                var e, i = n.find(".qodef-pricing-table-background"),
                    o = n.find("> div.elementor-column");
                o.filter(".qodef--pricing--appear").length ? (e = o.filter(".qodef--pricing--appear").offset().left, i.css("width", o.filter(".qodef--pricing--appear").outerWidth())) : (e = o.first().offset().left, i.css("width", 0)), i.css("left", e - n.offset().left), o.mouseenter(function() {
                    var e = d(this),
                        o = e.outerWidth(),
                        t = n.offset().left,
                        t = e.offset().left - t;
                    i.css("width", o), i.css("left", t), i.css("animation", "none")
                }), n.mouseleave(function() {
                    o.filter(".qodef--pricing--appear").length ? (i.css("width", o.filter(".qodef--pricing--appear").outerWidth()), i.css("left", e - n.offset().left)) : (i.css("width", 0), i.css("left", -30), i.css("animation", "qode-fade-out .1s .5s forwards"))
                })
            })
        },
        init: function() {
            d(".qodef--pricing-has-appear").length && e.backgroundAnimation()
        }
    }
}(jQuery),
function(e) {
    "use strict";
    qodefCore.shortcodes.shiftup_core_progress_bar = {}, e(document).ready(function() {
        d.init()
    });
    var d = {
        init: function() {
    ...
    qodefCore.shortcodes.shiftup_core_progress_bar.qodefProgressBar = d
}(jQuery),
function(e) {
    "use strict";
    qodefCore.shortcodes.shiftup_core_single_image = {}, e(document).ready(function() {
        o.init()
    });
    var o = {
        init: function() {
            this.holder = e(".qodef-single-image.qodef--has-appear"), this.holder.length && this.holder.each(function() {
                o.initItem(e(this))
            })
        },
        initItem: function(e) {
    ...
    qodefCore.shortcodes.shiftup_core_single_image.qodefSingleImage = o
}(jQuery),
function(n) {
    "use strict";
    qodefCore.shortcodes.shiftup_core_tabs = {}, n(document).ready(function() {
        e.init()
    });
    var e = {
        init: function() {
    ...
    qodefCore.shortcodes.shiftup_core_tabs.qodefTabs = e
}(jQuery),
function(u) {
    "use strict";
    qodefCore.shortcodes.shiftup_core_triple_image_highlight = {}, u(window).on("load", function() {
        e.init()
    });
    var e = {
        init: function() {
            var s, a, f, c, l, e = u(".qodef-triple-image-highlight");
            e.length && (s = function(e, o, t) {
                e.css("z-index", 30), o.css("z-index", 20), t.css("z-index", 20)
            }, a = function(e, o) {
                e.find('div[class*="trigger"]').width(Math.round(o.position().left))
            }, f = function(e, o) {
                var t = e.find(".qodef-l"),
                    n = e.find(".qodef-r"),
                    e = e.find(".qodef-c"),
                    o = o.position().left + window.innerWidth / 10.5;
                t.css({
                    visibility: "visible",
                    transform: "matrix(0.55,0,0,0.55,-" + o + ",0)"
                }), n.css({
                    visibility: "visible",
                    transform: "matrix(0.55,0,0,0.55," + o + ",0)"
                }), e.css({
                ...
                var n, i = !1;
                if (void 0 !== t) switch (t.target.className) {
                    ...
                    case "qodef-right-trigger":
                        ...
                        break;
                    case "qodef-e-link":
                        e.data("animating", !(i = !0)), clearInterval(e.data("autoplay"))
                } else n = "right";
                i || (c(e, o, n), f(e, o))
            }, e.each(function() {
                var e, o, t = u(this),
                    n = t.find(".qodef-e-inner"),
                    i = t.find(".qodef-e-image-holder.qodef--center"),
                    d = t.find(".qodef-e-image-holder.qodef--left"),
                    r = t.find(".qodef-e-image-holder.qodef--right");
                t.data("animating", !1).data("autoplay", !1), e = d, o = r, i.addClass("qodef-c"), e.addClass("qodef-l"), o.addClass("qodef-r"), s(i, d, r), a(t, n), t.css("visibility", "visible"), f(t, n), t.data("autoplay", setInterval(function() {
                    l(t, n)
                }, 3e3)), t.on("click", function(e) {
                    t.data("animating") || (clearInterval(t.data("autoplay")), l(t, n, e))
                }), t.hasClass("qodef-navigation-enabled") && (d = t.find(".qodef-left-arrow"), r = t.find(".qodef-right-arrow"), d.on("click", function() {
                    t.data("animating") || (c(t, n, "left"), f(t, n))
                }), r.on("click", function() {
                    t.data("animating") || (c(t, n, "right"), f(t, n))
                })), u(window).on("resize", function() {
                    f(t, n), a(t, n), n.find(">div").css("transition", "none")
                })
            }))
        }
    };
    qodefCore.shortcodes.shiftup_core_triple_image_highlight.qodefTripleImageHighlight = e
}(jQuery),
function() {
    "use strict";
    qodefCore.shortcodes.shiftup_core_video_button = {}, qodefCore.shortcodes.shiftup_core_video_button.qodefMagnificPopup = qodef.qodefMagnificPopup
}(jQuery),
function(n) {
    "use strict";
    n(window).on("load", function() {
    ...
    var o = {
        init: function() {
            var e = n(".widget_shiftup_core_sticky_sidebar");
...
function(d) {
    ...
    var e = {
        backgroundAnimation: function() {
            var e = d(".qodef-header-navigation > ul ");
            e.length && e.each(function() {
                var n = d(this);
                n.append('<div class="qodef-main-menu-background"></div>');
                var e, i = n.find(".qodef-main-menu-background"),
                    o = n.find("> li.menu-item");
                o.filter(".current-menu-ancestor").length ? (e = o.filter(".current-menu-ancestor").offset().left, i.css("width", o.filter(".current-menu-ancestor").outerWidth())) : (e = o.first().offset().left, i.css("width", 0)), i.css("left", e - n.offset().left), o.mouseenter(function() {
                    var e = d(this),
                        o = e.outerWidth(),
                        t = n.offset().left,
                        t = e.offset().left - t;
                    ...
                    o.filter(".current-menu-ancestor").length ? (i.css("width", o.filter(".current-menu-ancestor").outerWidth()), i.css("left", e - n.offset().left)) : (i.css("width", 0), i.css("left", -30), i.css("animation", "qode-fade-out .1s .5s forwards"))
                })
            })
        },
        init: function() {
            d(".qodef-header--standard #qodef-page-header").length && e.backgroundAnimation()
        }
    }
}(jQuery),
function(d) {
    ...
    var e = {
        ...
        init: function() {
            d(".qodef-header--standard-extended #qodef-page-header").length && e.backgroundAnimation()
        }
    }
}(jQuery),
function(t) {
    ...
    var d = {
        init: function() {
            var e = i("a.qodef-search-opener"),
                o = e.closest(".widget_shiftup_core_search_opener").find(".qodef-search-minimal-form");
            o.find(".qodef-m-close");
            e.length && o.length && e.each(function() {
                var e = i(this),
                    o = e.closest(".widget_shiftup_core_search_opener"),
                    t = o.find(".qodef-search-minimal-form"),
                    n = t.find(".qodef-m-close");
                t.length && (e.on("click", function(e) {
                    e.preventDefault(), t.hasClass("qodef--opened") || e.stopPropagation(), d.openMinimal(t), o.addClass("qodef--opened")
                }), n.on("click", function(e) {
                    e.preventDefault(), d.closeMinimal(t), o.removeClass("qodef--opened")
                }), i(document).on("click", function(e) {
                    t.hasClass("qodef--opened") && t.find(".qodef-m-form-field")[0] !== i(e.target)[0] && (e.preventDefault(), d.closeMinimal(t), o.removeClass("qodef--opened"))
                }))
            })
        },
        openMinimal: function(e) {
            qodefCore.body.addClass("qodef-minimal-search--opened"), e.addClass("qodef--opened").find(".qodef-m-form-field")
        },
        closeMinimal: function(e) {
            qodefCore.body.removeClass("qodef-minimal-search--opened"), e.find(".qodef-m-form-field").val(""), e.removeClass("qodef--opened")
        }
    }
}(jQuery),
function(o) {
...
function(i) {
    ...
    var d = {
        ...
        percentNumber: 0,
        init: function(e) {
            this.holder = i("#qodef-page-spinner.qodef-layout--speedometer"), this.holder.length && d.animateSpinner(this.holder, e)
        },
        animateSpinner: function(e, o) {
            var t = e.find(".qodef-m-spinner-number-label"),
                n = e.find(".qodef-m-needle"),
                i = {
                    val: 0
                };
            gsap.to(i, 3, {
...
function(d) {
    "use strict";
    qodefCore.shortcodes.shiftup_core_instagram_list = {}, d(document).ready(function() {
        e.init()
    });
    var e = {
        init: function() {
    ...
    qodefCore.shortcodes.shiftup_core_instagram_list.qodefInstagram = e, qodefCore.shortcodes.shiftup_core_instagram_list.qodefSwiper = qodef.qodefSwiper
}(jQuery),
function() {
    "use strict";
    qodefCore.shortcodes.shiftup_core_product_category_list = {}, qodefCore.shortcodes.shiftup_core_product_category_list.qodefMasonryLayout = qodef.qodefMasonryLayout, qodefCore.shortcodes.shiftup_core_product_category_list.qodefSwiper = qodef.qodefSwiper
}(jQuery),
function(e) {
    "use strict";
    var t = "shiftup_core_product_list";
    qodefCore.shortcodes[t] = {}, "object" == typeof qodefCore.listShortcodesScripts && e.each(qodefCore.listShortcodesScripts, function(e, o) {
        qodefCore.shortcodes[t][e] = o
    })
}(jQuery),
...
function() {
    "use strict";
    qodefCore.shortcodes.shiftup_core_clients_list = {}, qodefCore.shortcodes.shiftup_core_clients_list.qodefSwiper = qodef.qodefSwiper
}(jQuery),
function() {
    "use strict";
    var e = "shiftup_core_masonry_gallery_list";
    qodefCore.shortcodes[e] = {}, qodefCore.shortcodes[e].qodefMasonryLayout = qodef.qodefMasonryLayout
}(jQuery),
function(e) {
    "use strict";
    var t = "shiftup_core_portfolio_list";
    qodefCore.shortcodes[t] = {}, "object" == typeof qodefCore.listShortcodesScripts && e.each(qodefCore.listShortcodesScripts, function(e, o) {
        qodefCore.shortcodes[t][e] = o
    })
}(jQuery),
function() {
    "use strict";
    qodefCore.shortcodes.shiftup_core_testimonials_list = {}, qodefCore.shortcodes.shiftup_core_testimonials_list.qodefSwiper = qodef.qodefSwiper
}(jQuery),
function(i) {
    "use strict";
    i(document).ready(function() {
    ...
    var e = {
        ...
        initItem: function(e) {
            var t = e.find(".qodef-m-text-item"),
                n = e.find(".qodef-m-item");
            t.eq(0).addClass("qodef--active"), n.eq(0).addClass("qodef--active"), n.on("click", function(e) {
                var o = i(this);
                qodefCore.html.hasClass("touchevents") && o.hasClass("qodef--active") || (e.preventDefault(), t.removeClass("qodef--active").eq(o.index()).addClass("qodef--active"), n.removeClass("qodef--active").eq(o.index()).addClass("qodef--active"))
            }).on("click", function() {
                var e = i(this);
                qodefCore.html.hasClass("touchevents") && e.hasClass("qodef--active") || (n.removeClass("qodef--active").eq(e.index()).addClass("qodef--active"), t.removeClass("qodef--active").eq(e.index()).addClass("qodef--active"))
            }), e.addClass("qodef--init")
        }
    };
    qodefCore.shortcodes.shiftup_core_interactive_link_showcase.qodefInteractiveLinkShowcaseList = e
}(jQuery),
function(d) {
    "use strict";
    d(document).ready(function() {
        e.init()
    }), d(document).on("shiftup_trigger_get_new_posts", function() {
        e.init()
    });
    var e = {
        init: function() {
    ...
    qodefCore.shortcodes.shiftup_core_portfolio_list.qodefInfoFollow = e
}(jQuery);