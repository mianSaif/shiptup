! function(n) {
    ...
    n(window).on("elementor/frontend/init", function() {
        o.init(), e.init(), f.init(), t.init(), i.init()
    });
    var o = {
            init: function() {
        ...
        f = {
            init: function(e) {
                var o, a, t, _ = e,
                    r = Boolean(elementorFrontend.isEditMode()),
                    d = [],
                    i = {};
                r && void 0 !== e ? (t = window.elementor.elements, o = _.data("id"), a = _.hasClass("elementor-inner-section"), n.each(t.models, function(e, t) {
                    o == t.id ? i = t.attributes.settings.attributes : a && void 0 !== t.attributes.elements.models[0].attributes.elements.models[0].attributes.settings.attributes && o == t.attributes.elements.models[0].attributes.elements.models[0].attributes.id && (i = t.attributes.elements.models[0].attributes.elements.models[0].attributes.settings.attributes)
        ...
        t = {
            init: function() {
                elementorFrontend.hooks.addAction("frontend/element_ready/column", i.init)
            }
        },
        i = {
            init: function(e) {
