...
function(e) {
    ...
    var s = {
        ...
        sliderLoop: function(t, e) {
            ...
            }, 3e3), s.isInView(t), 1024 < qodef.windowWidth ? t.on("mouseenter", function() {
                e = !0
    ...
    var u = {
        ...
        initItem: function(e) {
            ...
            e.hasClass("qodef--only-content") && (o = o.map(function(e) {
                return ".elementor-section-wrap " + e
...
function(n) {
    ...
    var i = {
        init: function() {
            this.noticeHolder = n(".qodef-admin-notice"), this.noticeHolder.length && this.handleNotice()
        },
            ...
            e.length && e.each(function() {
                ...
                e.on("click", function(e) {
                    e.preventDefault(), n.ajax({
                        ...
                        url: ajaxurl,
                        success: function(e) {
                            "success" === n.parseJSON(e).status && i.noticeHolder.slideUp("fast")
                        }
                    })
                })
            })
